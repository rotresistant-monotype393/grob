...
Thirteen modules are auto-available in every script. No `import` required.
...
| `formatAs` | Output formatting — terminal collection-to-string operations |
| `guid` | GUID generation, parsing and formatting |
